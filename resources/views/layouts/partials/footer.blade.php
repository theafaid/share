			...
			<div class="col-lg-3  col-md-12">
				<div class="single-footer-widget mail-chimp">
					...
					<ul class="instafeed d-flex flex-wrap">
						<li><img src="{{asset('design')}}/img/i1.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i2.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i3.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i4.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i5.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i6.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i7.jpg" alt=""></li>
						<li><img src="{{asset('design')}}/img/i8.jpg" alt=""></li>
					</ul>
				</div>
			</div>
		</div>
